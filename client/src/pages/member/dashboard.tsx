...
import { LogOut, Dumbbell, Clock, TrendingUp, CheckCircle2, Flame, Calendar, Zap, GripVertical, Timer } from "lucide-react";
...
const DEFAULT_ORDER: SectionId[] = [
  "stats", "progress", "assigned-workouts", "today-workout", "attendance", "history",
];
...
function GripHandle({ onGrip }: { onGrip: (e: React.PointerEvent) => void }) {
  return (
    <div
      className="cursor-grab active:cursor-grabbing touch-none p-1.5 rounded-lg opacity-20 hover:opacity-50 transition-opacity select-none"
...
function DragItem({ id, children }: {
  id: SectionId;
  children: (grip: (e: React.PointerEvent) => void) => React.ReactNode;
}) {
  const controls = useDragControls();
  const startDrag = (e: React.PointerEvent) => { e.preventDefault(); controls.start(e); };
  return (
    <Reorder.Item
      value={id}
      dragListener={false}
        ...
        return (
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-1 bg-card border border-border rounded-2xl p-4 text-center">
              <div className="flex justify-end mb-1"><GripHandle onGrip={grip} /></div>
            ...
            <div className="col-span-1 bg-card border border-border rounded-2xl p-4 text-center">
              <Flame className="h-5 w-5 text-orange-400 mx-auto mb-2 mt-7" />
            ...
            <div className="col-span-1 bg-card border border-border rounded-2xl p-4 text-center">
              <CheckCircle2 className="h-5 w-5 text-green-500 mx-auto mb-2 mt-7" />
        ...
        return (
          <div className="space-y-3">
            <div className="flex items-center gap-2 px-1">
              ...
              <h2 className="font-semibold text-sm flex-1">Entrenamientos asignados</h2>
              <GripHandle onGrip={grip} />
            </div>
        ...
        return (
          <div className="bg-card border border-border rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-sm flex-1">Entrenamiento de hoy</h2>
              <GripHandle onGrip={grip} />
            </div>
        ...
        return (
          <div className="bg-card border border-border rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-sm flex-1">Asistencia — últimos 30 días</h2>
              <GripHandle onGrip={grip} />
            </div>
        ...
        return (
          <div className="bg-card border border-border rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-semibold text-sm flex-1">Historial de entradas</h2>
              <GripHandle onGrip={grip} />
            </div>
            {checkInsLoading ? (
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        {/* Check-in button — always static at top */}
        <CheckInButton checkIns={checkIns} member={member} />

        {/* Draggable sections */}
        <Reorder.Group axis="y" values={visibleSections} onReorder={handleReorder} className="flex flex-col gap-5">
